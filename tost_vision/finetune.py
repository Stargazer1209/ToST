...
# parsers
parser = argparse.ArgumentParser(description='Finetuning ToST')
...
parser.add_argument('--patch', default='4', type=int, help="patch size")
parser.add_argument('--ckpt_dir', type=str, default=None,help='location for the pretrained model weight')
